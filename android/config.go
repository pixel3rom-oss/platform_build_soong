...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Google.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.GoogleConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Google.Specific_camera_parameter_library)
}
